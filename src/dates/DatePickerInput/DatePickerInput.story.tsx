...
export function Range() {
  return (
    <div style={{ padding: 40, rowGap: "2rem", display: "flex", flexDirection: "column" }}>
      <DatePickerInput type="range" label="Date picker input" />
      <DatePickerInput type="range" disabled label="Custom labelSeparator" labelSeparator="~" />
    </div>
  )
}
