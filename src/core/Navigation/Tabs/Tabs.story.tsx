...
export function DefaultVariant() {
  return (
    <div>
      ...
      <Wrapper color="crayola" defaultValue="react" orientation="vertical">
        {base}
      </Wrapper>

      <Wrapper color="crayola" defaultValue="react" orientation="vertical" placement="right">
        {base}
      </Wrapper>
    </div>
  )
...
export const Grow = () => (
  <Wrapper defaultValue="react">
    <Tabs.List grow>
      ...
      <Tabs.Tab leftSection={<IconPackage size={16} />} value="react">
        React
      </Tabs.Tab>
      <Tabs.Tab leftSection={<IconPackage size={16} />} value="sv">Svelte</Tabs.Tab>
      <Tabs.Tab leftSection={<IconPackage size={16} />} value="ng">Wrapped tab</Tabs.Tab>
      <Tabs.Tab leftSection={<IconPackage size={16} />} value="ds" disabled>
        Disabled
      </Tabs.Tab>
    </Tabs.List>
