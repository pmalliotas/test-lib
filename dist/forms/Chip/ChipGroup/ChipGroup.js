...
export var ChipGroupForm = function (_a) {
    ...
    }).field, value = _b.value, fieldOnChange = _b.onChange, ref = _b.ref, field = __rest(_b, ["value", "onChange", "ref"]);
    return (_jsx($ChipGroup, __assign({ value: value, onChange: function (e) {
            fieldOnChange(e);
