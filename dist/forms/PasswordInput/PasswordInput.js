...
import { PasswordInput as $PasswordInput, } from "src/core";
export function PasswordInputForm(_a) {
    var _b;
    ...
    return (_jsx($PasswordInput, __assign({ value: value, onChange: function (e) {
            fieldOnChange(e);
