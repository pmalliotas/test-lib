...
import { type TextareaProps as $TextareaProps } from "../../core";
export declare type TextareaFormProps<T extends FieldValues> = UseControllerProps<T> & Omit<$TextareaProps, "value" | "defaultValue">;
