...
import { DatePickerInput as $DatePickerInput, } from "src/dates";
export function DatePickerInputForm(_a) {
    var _b;
    ...
    return (_jsx($DatePickerInput, __assign({ error: (_b = fieldState.error) === null || _b === void 0 ? void 0 : _b.message, value: value, onChange: function (e) {
            fieldOnChange(e);
