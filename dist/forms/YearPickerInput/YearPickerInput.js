...
import { YearPickerInput as $YearPickerInput, } from "src/dates";
export function YearPickerInputForm(_a) {
    var _b;
    ...
    return (_jsx($YearPickerInput, __assign({ error: (_b = fieldState.error) === null || _b === void 0 ? void 0 : _b.message, value: value, onChange: function (e) {
            fieldOnChange(e);
