...
import { type RadioGroupProps as $RadioGroupProps } from "src/core";
export type RadioGroupFormProps<T extends FieldValues> = UseControllerProps<T> & Omit<$RadioGroupProps, "value" | "defaultValue">;
