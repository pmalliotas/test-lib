...
import { type FileInputProps as $FileInputProps } from "src/core";
export declare type FileInputFormProps<T extends FieldValues> = UseControllerProps<T> & Omit<$FileInputProps, "value" | "defaultValue">;
