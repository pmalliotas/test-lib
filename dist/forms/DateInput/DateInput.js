...
import { DateInput as $DateInput } from "../../dates";
export function DateInputForm(_a) {
    var _b;
    ...
    return (_jsx($DateInput, __assign({ error: (_b = fieldState.error) === null || _b === void 0 ? void 0 : _b.message, value: value, onChange: function (e) {
            fieldOnChange(e);
