...
import { type DateInputProps as $DateInputProps } from "../../dates";
export declare type DateInputFormProps<T extends FieldValues> = UseControllerProps<T> & Omit<$DateInputProps, "value" | "defaultValue">;
