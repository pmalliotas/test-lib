...
import { MonthPickerInput as $MonthPickerInput, } from "src/dates";
export function MonthPickerInputForm(_a) {
    var _b;
    ...
    return (_jsx($MonthPickerInput, __assign({ error: (_b = fieldState.error) === null || _b === void 0 ? void 0 : _b.message, value: value, onChange: function (e) {
            fieldOnChange(e);
