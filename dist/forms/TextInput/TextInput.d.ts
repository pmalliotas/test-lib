...
import { type TextInputProps as $TextInputProps } from "src/core";
export declare type TextInputFormProps<T extends FieldValues> = UseControllerProps<T> & Omit<$TextInputProps, "value" | "defaultValue">;
