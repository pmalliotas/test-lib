...
export var CheckboxForm = function (_a) {
    var _b;
    ...
    return (_jsx($Checkbox, __assign({ error: (_b = fieldState.error) === null || _b === void 0 ? void 0 : _b.message, value: value, checked: value, onChange: function (e) {
            fieldOnChange(e);
